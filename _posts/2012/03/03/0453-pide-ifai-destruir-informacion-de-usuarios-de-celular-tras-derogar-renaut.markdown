...
---
![](http://i.imgur.com/EKQXRhCm.jpg)


  México, DF. El Instituto Federal de Acceso a la Información y Protección de Datos (IFAI) pidió cancelar -destruir- la información recabada a los usuarios de telefonía celular, esto tras la decisión de la Cámara de Diputados de derogar el Renaut y en tanto ello ocurra dispuso que esa base de datos se mantenga bajo adecuado resguardo.
